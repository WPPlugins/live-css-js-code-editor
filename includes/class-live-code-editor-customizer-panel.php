...
$wp_customize->add_control( new Live_Code_Editor_Customizer_Control( $wp_customize, 'live_code_css_field', array(
    ...
    'description'       => __('CSS entered in the box below will be rendered within &lt;style&gt; tags.', 'live-code-editor'),
    'type'              => 'code',
    'mode'              => 'css',
...
$wp_customize->add_control( new Live_Code_Editor_Customizer_Control( $wp_customize, 'live_code_js_field', array(
    ...
    'description'       => __('JavaScript entered in the box below will be rendered within &lt;script&gt; tags.', 'live-code-editor'),
    'type'              => 'code',
    'mode'              => 'javascript',
    'preview_button'    => true,
...
$wp_customize->add_control( new Live_Code_Editor_Customizer_Control( $wp_customize, 'live_code_header_field', array(
    ...
    'description'       => __('Code entered in the box below will be rendered within the page &lt;head&gt; tag.', 'live-code-editor'),
    'type'              => 'code',
    'preview_button'    => true,
...
$wp_customize->add_control( new Live_Code_Editor_Customizer_Control( $wp_customize, 'live_code_footer_field', array(
    ...
    'description'       => __('Code entered in the box below will be rendered directly before the closing &lt;body&gt; tag.', 'live-code-editor'),
    'type'              => 'code',
    'preview_button'    => true,
